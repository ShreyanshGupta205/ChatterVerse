        ...
        <div className="min-h-screen bg-[#09090b] flex items-center justify-center p-4 sm:p-6">
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-1.5 focus-within:text-indigo-400 text-white/20 transition-colors">
                        <label className="text-[10px] font-black uppercase tracking-[0.2em] ml-1">Email</label>
                        <div className="relative group">
                            <Mail className="absolute left-4 top-1/2 -translate-y-1/2 p-0.5 group-focus-within:text-indigo-400 transition-colors" size={18} />
                            <input
                                type="email"
                                value={formData.email}
                                onChange={(e) => setFormData({ ...formData, email: e.target.value })}
                                className="w-full bg-[#121215] border border-white/5 rounded-2xl py-3.5 pl-12 pr-4 text-sm text-white/80 outline-none focus:border-indigo-500/50 transition-all font-medium"
                    ...
                    <div className="space-y-1.5 focus-within:text-indigo-400 text-white/20 transition-colors">
                        ...
                        <div className="relative group">
                            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 p-0.5 group-focus-within:text-indigo-400 transition-colors" size={18} />
                            <input
                                type="password"
                    ...
                    <button 
                        type="submit" 
                        disabled={loading}
                        className="w-full bg-indigo-500 hover:bg-indigo-400 text-white py-4 rounded-2xl font-black text-sm transition-all shadow-indigo mt-4 active:scale-95 disabled:opacity-50"
                    >
                ...
                <div className="mt-8 text-center">
                    <p className="text-xs text-white/20 font-medium">
                        Don't have an account? <Link to="/signup" className="text-indigo-400 font-black hover:underline underline-offset-4">Create one</Link>
                    </p>
                </div>
            </motion.div>
        </div>
