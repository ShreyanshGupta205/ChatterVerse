                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-12 mb-16">
                        ...
                        <div className="col-span-2 md:col-span-2">
                            ...
                            <div className="flex gap-4">
                                ...
                                <a href="https://www.instagram.com/shreyanshg2005/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-pink-400 transition-all p-2 bg-white/5 hover:bg-white/10 rounded-full" aria-label="Instagram">
